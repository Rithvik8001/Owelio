    ...
    <footer className="border-t border-zinc-100 bg-white px-6 py-8">
      <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
        <p className="text-xs text-zinc-400">
          © 2026 Owelio &nbsp;·&nbsp; Made with ❤️ by{" "}
          <a
            href="https://github.com/Rithvik8001"
            target="_blank"
            rel="noopener noreferrer"
            className="text-zinc-500 underline-offset-2 transition-colors hover:text-zinc-900 hover:underline"
          >
            Rithvik
          </a>
        </p>
        ...
        <a
          href="https://github.com/Rithvik8001/Owelio"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Owelio on GitHub"
